    ...
    return (
        <header className={styles.header}>
            <div className="container">
                ...
                <div className={`${styles.center} ${styles.mt}`}><p className="text-base w-[45em]">Ambush is a minimal library that brings plenty of handy utilities to your code. Ambush prioritizes performance and is tailored to enhance your development experience while keeping things lean and efficient.</p></div>
