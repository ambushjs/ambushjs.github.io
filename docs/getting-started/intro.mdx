...
See [here][import] if you need more explanation.
...
If you're eager to learn JavaScript but still new to it, explore these helpful websites:
...
[import]: /docs/getting-started/import
[starting]: /docs/category/getting-started
